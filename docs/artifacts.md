...
| AI Magazine 1984 KEE paper | Primary IntelliCorp-authored description of KEE as a hybrid environment combining frames, rules, Lisp, interactive graphics, and active values. | https://ojs.aaai.org/aimagazine/index.php/aimagazine/article/view/447; metadata fallbacks: https://dblp.org/rec/journals/aim/KunzKW84, https://doi.org/10.1609/aimag.v5i3.447, https://api.openalex.org/works/W2736597073 |
