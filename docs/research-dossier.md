...
| Kunz, Kehler, Williams, "Applications Development Using a Hybrid Artificial Intelligence Development System" | Confirmed artifact | AI Magazine 1984 paper by IntelliCorp authors. Describes KEE as a hybrid environment combining frames, rules, Lisp, interactive graphics, and active values. Source: https://ojs.aaai.org/aimagazine/index.php/aimagazine/article/view/447 |
...
| Filman, "Reasoning with Worlds and Truth Maintenance in a Knowledge-Based Programming Environment" | Confirmed artifact | CACM 1988 article on extending KEE with worlds and truth maintenance. Good target for KEEworlds and ATMS behavior. Source: https://citeseerx.ist.psu.edu/document?doi=3a6acacb32bbc48ff773481e45681824c5d14a32&repid=rep1&type=pdf |
...
| SimKit | Confirmed | WSC 1989 and simulation literature describe a KEE-based simulation/model-building toolkit. Source: https://repository.lib.ncsu.edu/items/461ffbbe-1936-47f6-8f33-66309300547b |
...
| Source | Status | Why it matters |
| --- | --- | --- |
| NPS AUV mission planning | Confirmed | Public thesis with appendix listings and GUI/image-panel evidence on Symbolics 3675 and planned TI Micro-Explorer delivery. https://hdl.handle.net/10945/23457 |
| ASKE thesis | Confirmed | KEE 3.1 on Unisys/TI Explorer; Common Windows GUI vocabulary and rule-acquisition workflow. https://oro.open.ac.uk/64573/1/27758423.pdf |
